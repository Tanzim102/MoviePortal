<%@ Page Language="C#" AutoEventWireup="true" CodeFile="regadmin.aspx.cs" Inherits="adminreg" %>
...
<body style="height: 730px; margin-left: 190px; margin-right: 190px; margin-bottom: 0px">
  ...
  <div class="container">
    ...
    <tr>
        <td class="auto-style11">Admin name:</td>
...
<script type="text/javascript"> 
  ...
  <asp:Label ID="Label1" runat="server" ForeColor="White"></asp:Label>
    ...
    <p>Already have an account? <a href="loginadmin.aspx">Sign in</a>.</p>
  </div>
       <div><a href="reguser.aspx">Register as an <strong>User</strong></div>
      <div>
          <p>
              <li><a href="" onclick="window.open('ForgetPassword.aspx','FP','width=50,top=300.left=500,fullscreen=no,resizable=0');">Forget Password?</a>
