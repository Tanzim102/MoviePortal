            ...
            <td class="auto-style12">
              <dl>
               <dd class="auto-style15">&nbsp; Login</dd>
                ...
                <dl>
               <dd class="auto-style20">&nbsp;<span class="auto-style21">&nbsp;Admin Name</span></dd>
               <dd><br>
                   <asp:TextBox ID="adminname" runat="server" Width="397px" Height="28px" CssClass="auto-style16"></asp:TextBox>
                  </dd>
               <dd></dd>
                  <dd class="auto-style19">&nbsp;<span class="auto-style21">Password</span></dd>
               <dd>
                   <asp:TextBox ID="password" runat="server" Width="397px" Height="28px" CssClass="auto-style17" TextMode="Password"></asp:TextBox>
                  </dd>
               <dd class="auto-style13">
                   ...
                   <asp:Button ID="Button1" runat="server" Text="Login" Height="40px" Width="80px" Font-Size="Large" OnClick="Button1_Click1" CssClass="auto-style17" />
                    ...
                    <br />
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <asp:CheckBox ID ="remembermee" runat="server"  Text =" remember password" CssClass="auto-style14" />
